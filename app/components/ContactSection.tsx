				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<h2 className="text-3xl font-bold mb-8 text-gray-200">Let&apos;s Connect 🙋🏻‍♀️</h2>
							...
							<motion.a
								href="mailto:heeyeon.yune@gmail.com"
							...
							*/}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								{/* GitHub */}
								<motion.a
									href="https://github.com/heeyeonyune"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@heeyeonyune</p>
									</div>
								</motion.a>

								{/* LinkedIn */}
								<motion.a
									href="http://linkedin.com/in/heeyeon-yoon-47b169264"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Heeyeon Yoon</p>
									</div>
								</motion.a>
								{/*
								<motion.a
